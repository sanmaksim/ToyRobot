...
public static class RobotController
{
    ...
    public static Place? Place(string input, Place? place)
    {
    ...
    public static Place? Move(Place? place)
    {
        int lowerBound = 0;
        int upperBound = 5;
    ...
    public static Place? Left(Place? place)
    {
        var dir = "";
    ...
    public static Place? Right(Place? place)
    {
        var dir = "";
    ...
    public static void Report(Place? place)
    {
        if (place == null)
            Console.WriteLine("You must PLACE the toy robot first.");
        else
    ...
    public static Place? Control(string input, Place? place)
    {
